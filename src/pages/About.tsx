...
const About: React.FC = () => (
  <Container maxWidth="md" sx={{ mt: 6 }}>
    <Box sx={{ p: 4, background: '#f5f5f5', borderRadius: 2 }}>
      <Typography variant="h4" gutterBottom>About JustYou</Typography>
      <Typography variant="body1" sx={{ mb: 2 }}>
        <b>JustYou</b> is your personal vault for life stories and experiences. Here, you can create a collection of personalized stories—moments, memories, and reflections that matter to you.
      </Typography>
      <Typography variant="body1" sx={{ mb: 2 }}>
